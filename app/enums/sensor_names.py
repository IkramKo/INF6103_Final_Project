...
class SensorNames(Enum):
    ...
    # Pipes
    UNTREATED_TANK_INPUT_PIPE_DEBIT = 'P_Debit_TRTM_In'
    UNTREATED_TANK_OUTPUT_PIPE_DEBIT = 'P_Debit_TRTM_Out'
    TREATED_TANK_OUTPUT_PIPE_DEBIT = 'P_Debit_TRT_Out'
    RETREATEMENT_PIPE_DEBIT = 'P_Debit_RTRTM'
